...
{
    public partial class TMHShopContext : DbContext
    {
        public TMHShopContext()
        {
        }

        public TMHShopContext(DbContextOptions<TMHShopContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=TRANMINHHIEU\\SQLEXPRESS;Initial Catalog=TMHShop;Integrated Security=True");
//            }
//        }
